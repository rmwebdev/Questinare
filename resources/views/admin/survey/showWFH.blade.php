...
/* button:hover {
    color: #fff;
    background-color: #a4a4b6 !important;
    border-color: #272687 !important;
} */
    ...
    <div class="col-lg-6" style="margin:auto; padding:0;">
        ...
        <div class="card-box" style="border-radius:0">
            <div class="gambar" style="margin:auto; display: table; text-align: center; margin-top: -2% !important;">
                <img src="{{ asset('assets/images/icon_go.png')}}" alt="" class="avatar-xl rounded-circle mb-1"><br>
            ...
            <form class="parsley-examples" action="{{ route('kuisioner-1-harian-step-final') }}" method="post" novalidate="false" id="dataKaryawan">
                @csrf
                ...
                <div class="form-group"style="border-top: 1px solid gainsboro;">
                    ...
                    <input type="text" class="form-control" id="tgl_bekerja" value="{{$data_survey['tgl_kerja']}}" readonly name="tgl_kerja">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <div>
                        <div class="input-group">
                        <input type="text" class="form-control" id="pilih_divisis" value="{{$data_survey['divisi']}}" readonly name="divisi">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        @else
                        <input type="text" class="form-control" id="ponsel" value="{{$data_survey['no_ponsel']}}" readonly name="no_ponsel">
                        @endif
                        {{-- <div class="input-group-append"><span class="input-group-text"><i class=""></i></span>
                        </div> --}}
                ...
                <div class="form-group mb-0" style="">
                    ...
                    <p style="text-align: center;padding-bottom: 10px;">Tetap patuhi Protokol Pencegahan Covid-19. Gunakan Masker dengan baik dan Terapkan Physical Distancing!</p>
                    </div>
                    @endif
                    <div>
